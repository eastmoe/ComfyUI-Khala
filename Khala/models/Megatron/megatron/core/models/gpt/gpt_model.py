...
# ------------------------------------------------------------------------
from core.core_dynamic_embedding import MultiLayerLanguageModelEmbedding
# ------------------------------------------------------------------------
...
class GPTModel(LanguageModule):
    ...
    def __init__(
        ...
        if self.pre_process or self.mtp_process:
            self.embedding = MultiLayerLanguageModelEmbedding(
                config=self.config,
    ...
    def forward_hidden_states(
        ...
        *,
        ...
        """Run GPT forward pass and return decoder hidden states before output projection."""
